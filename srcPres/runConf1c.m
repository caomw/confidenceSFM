...
if (demoOn)
    ...
    waitFor('1');
    Screen(window,'WaitBlanking');
    Screen(window,'DrawText','1 (left tilt, certain)');

    Screen(window,'WaitBlanking');
    Screen(window,'DrawText','Press 2: ',200,575);
    waitFor('2');
    Screen(window,'WaitBlanking');
    Screen(window,'DrawText','2 (left tilt - medium confidence)');

    Screen(window,'WaitBlanking');
    Screen(window,'DrawText','Press 3: ',200,600);
    waitFor('3');
    Screen(window,'WaitBlanking');
    Screen(window,'DrawText','3 (left tilt - guessing)');
    ...
    waitFor('4');
    Screen(window,'WaitBlanking');
    Screen(window,'DrawText','4 (right tilt, guessing)');

    Screen(window,'WaitBlanking');
    Screen(window,'DrawText','Press 5: ',200,275);
    waitFor('5');
    Screen(window,'WaitBlanking');
    Screen(window,'DrawText','5 (right tilt, medium confidence)');

    Screen(window,'WaitBlanking');
    Screen(window,'DrawText','Press 6: ',200,300);
    waitFor('6');
    Screen(window,'WaitBlanking');
    Screen(window,'DrawText','6 (right tilt, certain)');
...
for trial = 1 : nTrials
    ...
    try
        ...
        Screen(window,'WaitBlanking');
        Screen(window,'DrawText',...
            '1 : \ (certain)   2 : \       3: \ (guessing)          4: / (guessing)  5: /      6: / (certain)  ',100,400,0);
        Screen(window,'DrawText',...
            '?',500,350,0);
