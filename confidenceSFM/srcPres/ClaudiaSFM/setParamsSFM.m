...
SFM.fixationXY = [400 300]; % half of the screen 
    
SFM.distFromFixation = 200; % in pixel , from fixation to the center of SFM

SFM.dotSize = 4 ; % size of the dot 
SFM.color1 = [150 0 0]; 
SFM.color1 = [0 80 0]; 
SFM.nDots = 200; % 150

SFM.vDisparity = [0 0.05 0.10 ] ; % potential disparity , 0 for completely ambiguous

SFM.spinaxis = 2; % 1 for vertical, 2 for horizontal rotation 
SFM.dispFlag = 1; % 0 for disabling disparity 


SFM.radius = 4.0;  %degrees
