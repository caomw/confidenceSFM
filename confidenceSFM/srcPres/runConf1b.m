...
% filename
sessionNum = 1;
while exist(sprintf('..\\dataRaw\\%s\\conf1B_%s%3.3d.mat',subjectID,subjectID,sessionNum));
    sessionNum = sessionNum+1;
end

fileName = sprintf('..\\dataRaw\\%s\\conf1B_%s%3.3d.mat',subjectID,subjectID,sessionNum)
...
% change here
if ((length(targetOri)~=4)|(mod(nTrials,length(targetOri)*4)))
